...
# calarea('s',12)
# calarea('c',12)
# from myexperiance.simplefile import read as simpleread#func,var,class,module
# from  myexperiance.db import dbmysq
# def read():
#     pass
# # print(modes)
# read()
# simpleread('asd.txt')
# # # overloading function has same declared many times argscount &datatype
# # def mysum():
# #     pass
# # # print(mysum)
# # def mysum(x,y):
...
# # # #
# # # # import  os
# # # # import simplefile#open dsimplefile.py copy code & past
# # # # print(simplefile.read('asd.txt'))
